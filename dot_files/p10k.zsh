# Generated by Powerlevel10k configuration wizard on 2021-07-12 at 12:37 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=245
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=133
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=133
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=25
  ...
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=136
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_WARNING_BACKGROUND=96
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|terraform|terragrunt'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=111
  ...
  # Show P9K_KUBECONTEXT_PROFILE and fall back to P9K_KUBECONTEXT_NAME
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_PROFILE:-${P9K_KUBECONTEXT_NAME}}'
