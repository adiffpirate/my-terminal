...
let s:gb.dark1       = ['#0f0f0f', 237]     " 60-56-54
let s:gb.dark2       = ['#1a1a1a', 237]     " 80-73-69
let s:gb.dark3       = ['#303030', 241]     " 102-92-84
let s:gb.dark4       = ['#4a4a4a', 243]     " 124-111-100
let s:gb.dark4_256   = ['#7c6f64', 243]     " 124-111-100

let s:gb.gray_245    = ['#494949', 245]     " 146-131-116
let s:gb.gray_244    = ['#928374', 244]     " 146-131-116

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#606060', 229]     " 253-244-193
let s:gb.light0_soft = ['#f2e5bc', 228]     " 242-229-188
let s:gb.light1      = ['#7a7a7a', 223]     " 235-219-178
let s:gb.light2      = ['#949494', 250]     " 213-196-161
let s:gb.light3      = ['#afafaf', 248]     " 189-174-147
let s:gb.light4      = ['#c9c9c9', 246]     " 168-153-132
let s:gb.light4_256  = ['#a89984', 246]     " 168-153-132

let s:gb.bright_red     = ['#fb5a47', 167]     " 251-73-52
let s:gb.bright_green   = ['#989a1f', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#f9b109', 214]     " 250-189-47
let s:gb.bright_blue    = ['#2d80a0', 109]     " 131-165-152
let s:gb.bright_purple  = ['#8463c3', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#77b362', 108]     " 142-192-124
let s:gb.bright_orange  = ['#ef6c01', 208]     " 254-128-25
...
if version >= 705
  ...
  call s:HL('ColorColumn',  s:bg1, s:color_column)

  " Concealed element: \lambda → λ
  call s:HL('Conceal', s:blue, s:none)

  " Line number of CursorLine
  call s:HL('CursorLineNr', s:fg2, s:bg2)
endif
...
call s:HL('StatusLine',   s:bg2, s:fg2, s:inverse)
call s:HL('StatusLineNC', s:bg2, s:bg1, s:inverse)

" The column separating vertically split windows
call s:HL('VertSplit', s:bg4, s:vert_split)
...
call s:HL('Cursor', s:none, s:red, s:inverse)
...
hi! link NERDTreeDir GruvboxGreen
